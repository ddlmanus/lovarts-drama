...
export const aiServiceProviders = sqliteTable('ai_service_providers', {
  ...
  supportOpenAI: integer('support_open_ai', { mode: 'boolean' }).default(false),
...
export const aiModelConfigs = sqliteTable('ai_model_configs', {
  ...
  sourceModelId: integer('source_model_id'),
  parameterProfileId: integer('parameter_profile_id'),
  serviceType: text('service_type').notNull(),
  provider: text('provider').notNull(),
...
export const aiModelParameterProfiles = sqliteTable('ai_model_parameter_profiles', {
  id: integer('id').primaryKey({ autoIncrement: true }),
...
export const aiModelParameterProfileItems = sqliteTable('ai_model_parameter_profile_items', {
  id: integer('id').primaryKey({ autoIncrement: true }),
...
export const aiUserProviderConfigs = sqliteTable('ai_user_provider_configs', {
  id: integer('id').primaryKey({ autoIncrement: true }),
...
export const imageGenerations = sqliteTable('image_generations', {
  ...
  model: text('model'),
  size: text('size'),
  sampleImageSize: text('sample_image_size'),
